# -*- coding: utf-8 -*-
# Generated by Django 1.9.11 on 2017-01-12 13:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('userid', models.IntegerField()),
                ('actionid', models.IntegerField()),
                ('report_type', models.CharField(choices=[(b'I', b'Invalid'), (b'T', b'Bad_Title'), (b'C', b'Copyrigh')], max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, upload_to=b'users/avatars')),
                ('createdDate', models.DateTimeField(auto_now_add=True)),
